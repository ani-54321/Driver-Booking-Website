<!-- This is Login form for drivers -->
...
<head>
  ...
  <title>Driver Login | GoGetWay</title>
</head>
...
<body>
  ...
  <?php
    ...
    else if(@$_GET['Success']==true)
    {
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Congratulations!</strong> <?php echo $_GET['Success'];?>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class='container bg-dark text-light my-3'>
    <h3 style="padding-top: 5px;"> Login Form </h3>
  ...
  <div class='container' style="width:50vm; background-color:#e5e5e5; height: 10vm;">
    <form method="POST" action="yesiftrue.php" style="padding:10px;">
      <div class="form-group my-4" style='width:100%'>
        <label for="email">Email address</label>
        <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp"
          autocomplete="off">
        <small id="emailHelp" class="form-text text-muted">Email by which you have enrolled...</small>
      </div>
      <div class="form-group my-5" style='width:100%'>
        <label for="password">Password</label>
        <input type="password" class="form-control" id="password" name="password" placeholder="Driver ID">
      </div>
