<?php
    ...
    if(isset($_POST['addAns'])){
        ...
        header("location:chattingPassengers.php?Success= Your answer is successfully sent...");
        ...
        header("location:chattingPassengers.php?Success= You will get response soon...");
      }
?>