      ...
      <div class="card-body">
        ...
        <p class="card-text"><?php
            if(count($answer)>0)
            {
              ...
              {
                $counterA+=1;
                echo "<b>" . $counterA. ") " . " Answered by ".$nameAns[$i] . " </b><br>";
...
?>
  ...
  <div class="form-group" id="answer" style="z-index:+100; width:80%; margin: auto;">
    <form method="post" action="addQandADrivers.php">
      ...
      <button type="submit" name="submit" class="btn btn-primary" style="margin: 2%;" id="submit" value="">Submit</button>
    </form>
  </div>
  <div class="container">
