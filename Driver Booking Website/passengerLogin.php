...
<head>
  ...
  <title>Passenger Login | GoGetWay</title>
</head>
...
<body>
  ...
  <?php
    if(@$_GET['Success']==true)
    {
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Welcome!</strong> <?php echo $_GET['Success'];?>
  ...
  <div class='container bg-dark text-light my-3'>
    ...
    <p style="text-align: right; color: #a0a0a0; padding-bottom: 5px;"> For passengers... </p>
  </div>
  <div class='container' style="width:50vm; background-color:#e5e5e5; height: 10vm;">
    <form method="POST" action="pinornot.php" style="padding:10px;">
      <div class="form-group my-4" style='width:100%'>
        <label for="email">Username</label>
        <input type="text" class="form-control" id="email" name="mobile" autocomplete="off" placeholder="eg. Maddie">
